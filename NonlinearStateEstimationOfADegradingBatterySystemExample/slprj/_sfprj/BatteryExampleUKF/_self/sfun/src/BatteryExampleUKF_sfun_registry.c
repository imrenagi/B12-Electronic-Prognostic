...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_BatteryExampleUKF_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_sharedTrackingLibrary_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_BatteryExampleUKF_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_BatteryExampleUKF_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "BatteryExampleUKF") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_BatteryExampleUKF_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_BatteryExampleUKF_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "BatteryExampleUKF") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_BatteryExampleUKF_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_BatteryExampleUKF_jit_fallback_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "BatteryExampleUKF") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_BatteryExampleUKF_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_BatteryExampleUKF_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "BatteryExampleUKF") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_BatteryExampleUKF_updateBuildInfo_args_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_BatteryExampleUKF_get_eml_resolved_functions_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "BatteryExampleUKF") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_BatteryExampleUKF_get_eml_resolved_functions_info(nlhs,plhs,3,
      newRhs);
  }
...
extern unsigned int sf_BatteryExampleUKF_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"BatteryExampleUKF")) {
    return(sf_BatteryExampleUKF_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void BatteryExampleUKF_terminator(void);
...
extern void BatteryExampleUKF_initializer(void);
extern void sharedTrackingLibrary_initializer(void);
extern void BatteryExampleUKF_register_exported_symbols(SimStruct* S);
extern void sharedTrackingLibrary_register_exported_symbols(SimStruct* S);
extern void BatteryExampleUKF_debug_initialize(struct SfDebugInstanceStruct*);
...
{
  BatteryExampleUKF_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      BatteryExampleUKF_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    BatteryExampleUKF_initializer();
    if (!simModeIsRTWGen) {
